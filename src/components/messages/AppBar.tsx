        ...
        <div className="fixed bg-yellow-400  text-gray-900 left-0 w-full h-full pl-8 laptop:w-96 desktop:w-96">
            <section className="relative w-full h-full">             
                <div className="absolute space-y-1">
                    ...
                    <div className="text-lg underline font-semibold pt-2 pb-2">Yesterday</div>
                    ...
                    <div>
                        <CardAppBar sary={avatar2} nom="Maroon steve" text="Hello word"></CardAppBar>
                    </div>
                    <div>
                        <CardAppBar sary={avatar2} nom="Maroon steve" text="Kaiza! salama ve"></CardAppBar>
                    </div>
                </div>
            </section>
        </div>
